/* GRÁFICO DE PIE PARA VER DEPENDENCIA DE RECURSOS INTERNOS VS EXTERNOS */
$(document).ready(function() {
    ...
    function cargarGrafico() {
        ...
        $.ajax({
            url: '../controllers/GraficosController.php?action=ordenes-por-modo',
            method: 'GET',
            dataType: 'json',
                    ...
                    Highcharts.chart('container', {
                        ...
                        plotOptions: {
                            pie: {
                                ...
                                showInLegend: true,
                                colors: ['#007bff', '#28a745'] // Azul para recursos internos, verde para subcontratado
                            }
                        },
                        legend: {
                            align: 'center',
